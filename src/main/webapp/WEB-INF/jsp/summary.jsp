...
<div class="panel-body">
 <div class="block-nav">
	...
	%>
		...
		<!-- Create an emtpty Dataset for annotator -->
		...
		<div style="display:block;padding:2px  0px 5px 5px;background: #F2F2F2;border-bottom:1px solid #CCCCCC;">
			<span style="width:150px;display:inline-block"><b>Filter by Label:</b> </span><s:select theme="simple"  cssStyle="width:300px" name="filterlabel"  id="filterlabel" list="labels" headerKey="-1" headerValue="-- All labels --" listKey="%{lblname+'_'+lblcolor}"  listValue="lblname"  onChange="javascript:ajaxImportsPanel(0,importlimit,-1,document.getElementById('filterorg').value,$('#filterlabel').val());" multiple="true"></s:select>
		</div></s:if>
